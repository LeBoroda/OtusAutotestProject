...
public class QaLeadPage extends AbsTestingCoursePage{
    ...
    private final String courseLengthLocator = "//div[@id='__next']//following::section[2]/child::div[3]//div[2]/p";
    private final String courseFormatLocator = "//div[@id='__next']//following::section[2]/child::div[3]//div[3]/p";

    public QaLeadPage(WebDriver driver, String path) {
        super(driver, path);
    }
